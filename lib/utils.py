...
def save_tensor_images(image_tensor, img_name , num_images=16, size=(3, 64, 64)):
    '''
...
def run(n_samples ,img_name , checkpoint=checkpoint , code_dim=code_dim , device=device) : 
  # Load checkpoint
